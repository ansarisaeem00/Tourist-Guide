...
<div class="jumbotron">
  <div class="container text-center">
    <h1>User Data Managment Table</h1>
  </div>
</div>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <?php  
        $view_users_query="select id,name,email from users where user_type='user'";//select query for viewing users.  
        ...
        ?>  
                <tbody>
                    ...
                    <tr>
						...
						<td>
							<a  href="delete.php?del=<?php echo $user_id ?>"><i class="material-icons">&#xE5C9;</i></a>
						</td>
                    </tr>
				    </div>
